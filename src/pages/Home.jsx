  ...
  return (
    <div className=" flex justify-center mt-10 px-4 ">
        <div className="bg-white w-full pt-3 pb-10 px-5 ">
          <h1 className="text-3xl sm:text-2xl font-semibold text-black/80  mt-4 mb-6">
          ...
          <div className="flex flex-wrap gap-4 items-center">
            ...
            <button
              ...
              className="border rounded-sm border-gray-300 py-2 w-[23%] md:w-[31%] sm:w-[46%] xs:w-full h-[150px] text-2xl font-semibold  "
            >
              Create
            </button>
          </div>
